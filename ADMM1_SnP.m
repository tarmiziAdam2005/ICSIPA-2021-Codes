function out = ADMM1_SnP(f,Img,K,opts)
...
%
% where I(u) is the indicator function (Used to project the solution so that stays between pixels [0, 255].
%%
%  Input:
...
tg = tic;
    for k = 1:Nit
      ...
      %*** solve z - subproblem ***
      z = min(255,max(u + mu_z/rho_z,0)); %Project the pixels so that it stays in between 0 and 255
